...
<html>
    ...
    <title>Cotizacion de Tours</title>
    <style>
        @charset "utf-8";
        /* CSS Document */
        body {
    ...
    <div class="zona_impresion">
        ...
        <table  align="center" width="700px">
            <tr>
                <td align="center">
                    <img src="https://xn--campiatours-5db.com/assets/imagenes/logo.png" width="80px"></img><br>
        ...
        <table align="center" width="700px">   
            ...
            <tr>
                <td>Tipo Tours : {{$v->tiposturs}} </td>               
            </tr>  
            <tr>
                <td>Hora de Salida : {{$v->hora_salida}} </td>               
            </tr>  
            <tr>
                <td>Hora de Salida : {{$v->hora_llegada}} </td>               
            </tr>  
