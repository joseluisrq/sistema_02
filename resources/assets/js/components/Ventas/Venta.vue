                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row border">
                            ...
                            <div class="col-md-4">
                                <template v-if="tipo_comprobante=='TICKET'">
                                <div class="form-group">
                                    <label>Serie Comprobante</label>
                                    <input type="text" class="form-control" v-model="serie_comprobante" placeholder="000x" disabled>
                                </div>
                                </template>
                                <template v-else>
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                 <template v-if="tipo_comprobante=='TICKET'">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" v-model="num_comprobante" placeholder="000xx" disabled>
                                    </div>
                                  </template>
                                <template v-else>
                                         <div class="form-group">
        ...
        methods : {
            ...
            validarVenta(){
             ...
             generarCodigo(){
                let me=this;
                 let idventau=0;
                var url= this.ruta+'/venta/ultimaventa';               
                axios.get(url).then(function (response) {
                let respuesta= response.data;
                if(response.length==0){
                    idventau=1;
                }else{
                    idventau=respuesta.idultimaventa[0].id;
                }
               console.log(idventau)
                me.num_comprobante='Ticket-'+me.zfill(idventau,3);
